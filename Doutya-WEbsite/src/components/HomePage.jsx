  ...
  return (
    <div className="bg-blue-950 h-[60vh] sm:h-[80vh] flex flex-col items-center justify-center relative p-4">
      ...
      <div className="text-center text-white z-10 mt-[-2vh] sm:-mt-22">
        <h1 className="bg-gradient-to-b from-white to-black-50 p-4 sm:p-8 md:p-12 font-bold bg-clip-text text-transparent text-5xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-9xl leading-tight">
