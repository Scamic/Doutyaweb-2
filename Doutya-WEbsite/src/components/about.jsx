  ...
  return (
    <section className="bg-slate-950 text-white py-10 lg:py-20 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute w-56 h-56 bg-violet-400 rounded-full mix-blend-screen filter blur-2xl opacity-60 top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/5 animate-blob mt-22"></div>
        {/* <div className="absolute w-72 h-72 bg-blue-400 rounded-full mix-blend-screen filter blur-2xl opacity-70 top-0 left-1/4 transform -translate-x-1/2 -translate-y-1/2 animate-blob animation-delay-2000"></div> */}
        {/* <div className="absolute w-72 h-72 bg-pink-400 rounded-full mix-blend-screen filter blur-2xl opacity-70 top-0 left-3/4 transform -translate-x-1/2 -translate-y-1/2 animate-blob animation-delay-4000"></div> */}
      </div>
      ...
      <div className="container mx-auto px-4 flex flex-col lg:flex-row items-center lg:justify-between relative">
        ...
        <div className="  w-full lg:w-1/2 mb-10 lg:mb-0 lg:pr-8 text-center lg:text-left ml-8">
          <h2 className="text-violet-800 text-3xl sm:text-4xl lg:text-5xl font-bold mb-4 ">
            About Us
          </h2>
            <div className='bg-gray-800 focus:outline-none  rounded-lg border border-gray-600 pl-2 pr-2 pt-2 pb-2 '>  
        ...
        <div className="lg:w-1/2 flex justify-center lg:justify-end h-78 w-76 mr-6">
          <img
